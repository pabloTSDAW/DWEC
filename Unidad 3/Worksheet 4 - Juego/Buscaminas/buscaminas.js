...
class Partida {
  ...
  refrescarTablero(){
    ...
    for (var i = 0; i <= 7; i++) {
        document.write("<tr bgcolor='#bfbbbe' height=\"" + this.grosor + "\">");
      for (var j = 0; j <= 7; j++) {
        var pos = 0;
        if (celdas[pos].tapada == true)
           document.write("<td align='center' style='border:outset 5pt;' width=' " + this.grosor + "'>" + '&nbsp;' + "</td>");
        else{
          if (celdas[pos].numero == 'BOOM') document.write("<td align='center' style='border:inset 5pt;' bgcolor='#f04646' font-weight: bold;' width=' " + this.grosor + "'><img src='bomba.png' height='30px' width='30px'></td>");
          else if (celdas[pos].numero != 0 && celdas[pos] != 'BOOM') document.write("<td align='center' bgcolor='#d4d6d4' style='border: inset 5pt; color:" + celdas[pos].color + "; font-weight: bold;' width=' " + this.grosor + "'>" + celdas[pos].numero + "</td>");
          else document.write("<td align='center' bgcolor='#d4d6d4' style='border:inset 5pt; color:" + celdas[pos].color + "; font-weight: bold;' width=' " + this.grosor + "'>&nbsp;</td>");
        }
        celdas.push(celdas[pos]);
        celdas.shift();
      }
